...
$query = mysqli_query($con,"SELECT productName FROM products WHERE
                            productToken = '".$_GET['pt']."' ");
  $rw = mysqli_fetch_array($query);

  $token = $rw['productName'];
...
$quantity = 2;
  ...
  mysqli_query($con,"INSERT INTO  orders (orderToken, userEmail,productName,quantity)
  							VALUES('$hashedString','".$_SESSION['email']."','$pname','$quantity')");
...
mysqli_query($con,"INSERT INTO  orders (orderToken, userEmail,productName,quantity)
							VALUES('$orderToken','".$_SESSION['email']."','$qty','$quantity')");
