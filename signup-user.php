    ...
    <div class="container">
            <div class="form-div">
                <form action="signup-user.php" class="form" method="POST" autocomplete="">
                    ...
                    <div class="form-group">
                        <input class="form-input" type="text" id="phone" name="phone" onblur="checkPhone()" placeholder="phone number" required>
                        <br><span class="error-section" id="phoneAvailability"></span>
                    </div>
                    <div class="form-group">
