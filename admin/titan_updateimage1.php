...
header('location:index.php');
  ...
  $prodName=$_GET['prodName'];// product
...
if(isset($_POST['submit']))
{
	...
	move_uploaded_file($_FILES["productimage1"]["tmp_name"],"productimages/$prodName/".$_FILES["productimage1"]["name"]);
	$sql=mysqli_query($con,"UPDATE  products SET productImage1='$productimage1' WHERE productName='$prodName' ");
...
<?php
$query=mysqli_query($con,"SELECT productName,productImage1 FROM products WHERE productName='$prodName'");
$cnt=1;
...
?>
				...
				<img src="productimages/<?php echo htmlentities($prodName);?>/<?php echo htmlentities($row['productImage1']);?>" width="60" height="60">
				</div>

				<div class="adminform_div">
				<label class="adminform_label" for="basicinput">New Product Image1</label><br>
