...
if(isset($_POST['submit']))
{
  $name=$_POST['name'];
	...
	$couponToken=$_GET['couponToken'];

$sql=mysqli_query($con,"UPDATE coupon SET name='$name',type='$type', discount='$discount', status= '$status', validDate='$validDate', updateDate='$currentTime'
									WHERE couponToken = '".$_GET['couponToken']."'");
$_SESSION['msg']="Coupon Updated !!";
header("location:titan_coupons.php");
}
...
<?php
$query=mysqli_query($con,"SELECT * FROM coupon WHERE couponToken = '".$_GET['couponToken']."'");
...
?>
                  ...
                  <div class="adminform_div">
                    ...
                    <select name="discount"  id="discount" class="adminform_select" required>
                      <option value="<?php echo htmlentities($row['discount']); ?>"><?php echo htmlentities($row['discount']); ?></option>
                  ...
                  <div class="adminform_div">
                    ...
                    <input type="date" name="validDate" value="<?php echo htmlentities($row['validDate']);  ?>" class="adminform_input" required>
                  </div>
