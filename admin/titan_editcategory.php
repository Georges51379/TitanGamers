...
$sql=mysqli_query($con,"UPDATE category SET categoryName='$categoryName',categoryDescription='$categoryDescription', categoryStatus='$categoryStatus',
									...
									WHERE categoryToken = '".$_GET['catName']."'");
$_SESSION['msg']="Category Updated !!";
header("location:titan_category.php");
}
...
?>
										<div class="adminform_div">
											...
											<input type="text" placeholder="Enter Category Name" onblur="checkCatName()" id="categoryName" name="categoryName" value="<?php echo  htmlentities($row['categoryName']);?>" class="adminform_input" required>
										</div>
										<div class="adminform_div">
										...
										<div class="adminform_div">
											...
											<select type="text" placeholder="Enter Category Status" name="categoryStatus" class="adminform_input" required>
												<option value="<?php echo  htmlentities($row['categoryStatus']);?>"><?php echo  htmlentities($row['categoryStatus']);?></option>
