...
if(isset($_GET['del']))
		  {
			...
			if(isset($_POST['truncateManageUsersTable'])){
...
<center>
	<div class="container">
				<div class="titlewrapper">
					...
					<h4 class="subtitle"><a href="titan_insertusers.php" class="subtitle-link">insert users</a></h4>
				</div>
	...
	<?php } ?>
						...
						<form method="post">
							<h2>Empty Table:</h2>
							<button type="submit" name="truncateManageUsersTable" class="adminform_btn" onClick="return confirm('Are you sure you want to Empty this Table?')">Empty Table</button>
						</form>
									...
									<table id="datable" class="display" style="width:100%">
										<thead>
											...
											<th id="custom_td">donation</th>
											<th id="custom_td">Shippping Address/City/State/Pincode </th>
...
?>
										<tr id="custom_tr">
											...
											<td>
												<a href="titan_editusers.php?userToken=<?php echo $row['userToken']?>" ><i class="fa fa-plus"></i></a>
												<a href="titan_manageusers.php?userToken=<?php echo $row['userToken']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-times"></i></a>
											</td>
										<?php $cnt=$cnt+1; } ?>
								</table>
							</div>
