...
if(isset($_POST['submit']))
{
  ...
  $_SESSION['componentToken'] = $hashedString;

//insert variable to DB
$sql=mysqli_query($con,"INSERT INTO components (componentToken, componentName, componentStatus)
									VALUES('".$_SESSION['componentToken']."', '$componentName', '$componentStatus')");

$_SESSION['msg']="Component Inserted Successfully !!";
}
?>
<html lang="en">
<head>
	<title>Admin | Insert Component</title>
...
<body>
	...
	<div class="titlewrapper">
		<h3 class="title">insert Component</h3>
	</div>
	...
	<!--***********************************END ADD DELETE CATEGORY MSG*******************************************************-->
			...
			<form class="admin_form" name="insertbanner" method="post" enctype="multipart/form-data">
				...
				<div class="adminform_div">
					...
					<input type="text"  name="componentName"  placeholder="Enter Name" class="adminform_input" required>
				</div>
