...
<!--  for company name and description -->
  <div class="footer_categories">
    <h1 class="footer_title">titan gamers</h1>
    <p class="footer_desc">the store that all gamers have been waiting for</p>
  </div>
  ...
  <div class="footer_categories">
    ...
    <div class="border1"></div> <!--for the underline -->
      <ul class="footer_lists">
        <a href="#" class="footer_links"><li class="footer_li">fAQs</li></a>
        <a href="#" class="footer_links"><li class="footer_li">privacy policy</li></a>
        <a href="#" class="footer_links"><li class="footer_li">terms&conditions</li></a>
      </ul>
  </div>
...
<!--  for some other links -->
  <div class="footer_categories">
    ...
    <div class="border1"></div>  <!--for the underline -->
      <ul class="footer_lists">
        <a href="#" class="footer_links"><li class="footer_li">about us</li></a>
        <a href="#" class="footer_links"><li class="footer_li">shipping</li></a>
        <a href="#" class="footer_links"><li class="footer_li">delivery</li></a>
        <a href="#" class="footer_links"><li class="footer_li">return policy</li></a>
      </ul>
  </div>
<!--  for contact us info -->
  <div class="footer_categories">
    ...
    <div class="border1"></div>
      <ul class="footer_lists">
        ...
        <li class="footer_li"><i class="contactus_icon fa fa-envelope" aria-hidden="true"></i>titangamers.services@gmail.com</li>
      </ul>
<!--   for social links -->
...
<div class="footer_bottom">
  Copyright &copy; titan Gamers <script>document.write(new Date().getFullYear())</script>.
</div>
</footer>
